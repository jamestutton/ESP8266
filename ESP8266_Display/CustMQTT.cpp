 ...
 * mosquitto_pub -t "/home/devicestatus/display/fwotalink" -m "http://192.168.1.129:8000/ESP8266_Display.ino.d1.bin"
 */
...
extern void display_mqtt_status(boolean connected);
...
const char * mqtt_topics[] = {
  ...
  "/home/devicestatus/display/fwotalink",
};
...
void set_focus(mqtt_topic_type focus) {
  switch (last_focus) {
    case SONIC_SENSOR1_DOOR_STATUS:
      ...
      display.fillRect(0, 16, 4, 16);
      break;
    case TEMP_SENSOR1_TEMPERATURE:
      display.setColor(BLACK);
      display.fillRect(0, 32, 4, 16);
      break;
    case TEMP_SENSOR2_TEMPERATURE:
      display.setColor(BLACK);
      display.fillRect(40, 32, 4, 16);
      break;
    case TEMP_SENSOR3_TEMPERATURE:
      display.setColor(BLACK);
      display.fillRect(80, 32, 4, 16);
      break;
    case TEMP_SENSOR4_TEMPERATURE:
      display.setColor(BLACK);
      display.fillRect(0, 48, 4, 16);
      break;
    case TEMP_SENSOR5_TEMPERATURE:
      display.setColor(BLACK);
      display.fillRect(40, 48, 4, 16);
      break;
    default:
      break;
  }
  ...
  switch (last_focus) {
    case SONIC_SENSOR1_DOOR_STATUS:
      ...
      display.fillRect(0, 16 + 4, 4, 16 - 10);
      break;
    case TEMP_SENSOR1_TEMPERATURE:
      display.setColor(WHITE);
      display.fillRect(0, 32 + 4, 4, 16 - 10);
      break;
    case TEMP_SENSOR2_TEMPERATURE:
      display.setColor(WHITE);
      display.fillRect(40, 32 + 4, 4, 16 - 10);
      break;
    case TEMP_SENSOR3_TEMPERATURE:
      display.setColor(WHITE);
      display.fillRect(80, 32 + 4, 4, 16 - 10);
      break;
    case TEMP_SENSOR4_TEMPERATURE:
      display.setColor(WHITE);
      display.fillRect(0, 48 + 4, 4, 16 - 10);
      break;
    case TEMP_SENSOR5_TEMPERATURE:
      display.setColor(WHITE);
      display.fillRect(40, 48 + 4, 4, 16 - 10);
      break;
    default:
      break;
  }
...
void mqtt_client_callback(mqtt_topic_type topic_index, String &valuestr) {
  switch (topic_index) {
    case SONIC_SENSOR1_DOOR_STATUS:
      ...
      if (valuestr == "OPEN") {
        display.setColor(WHITE);
        display.fillRect(6, 16, 60, 14);
        display.setColor(BLACK);
        display.drawString(36, 16, valuestr);
      }
      else {
        display.setColor(BLACK);
        display.fillRect(6, 16, 60, 14);
        display.setColor(WHITE);
        display.drawRect(6, 16, 60, 14);
        display.drawString(36, 16, valuestr);
      }
    ...
    case TEMP_SENSOR1_TEMPERATURE:
      display.setColor(BLACK);
      display.fillRect(6, 32, 40, 16);
      display.setColor(WHITE);
      display.drawString(6, 32, valuestr);
      break;
    case TEMP_SENSOR2_TEMPERATURE:
      display.setColor(BLACK);
      display.fillRect(46, 32, 40, 16);
      display.setColor(WHITE);
      display.drawString(46, 32, valuestr);
      break;
    case TEMP_SENSOR3_TEMPERATURE:
      display.setColor(BLACK);
      display.fillRect(86, 32, 40, 16);
      display.setColor(WHITE);
      display.drawString(86, 32, valuestr);
      break;
    case TEMP_SENSOR4_TEMPERATURE:
      display.setColor(BLACK);
      display.fillRect(6, 48, 40, 16);
      display.setColor(WHITE);
      display.drawString(6, 48, valuestr);
      break;
    case TEMP_SENSOR5_TEMPERATURE:
      display.setColor(BLACK);
      display.fillRect(46, 48, 40, 16);
      display.setColor(WHITE);
      display.drawString(46, 48, valuestr);
      break;
